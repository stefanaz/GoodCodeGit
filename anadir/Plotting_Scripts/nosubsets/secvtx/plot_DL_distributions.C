plot_DL_distributions(char *name_histo, Int_t Nbins_DL, Int_t Nbins_DLS)
{
...
// #include "/data/zenith234d/stefan/PhD_work/Useful_Codes/Nevents_Histosum/Draw_Errorbar.C"
  ...
  string line;
  ifstream myfile ("/data/zenith234d/stefan/GutCode/anadir/run_analysis/date_file.txt");
  if (myfile.is_open())
  {
...
Int_t rebin_value = 100/Nbins_DL;
Int_t rebin_value_DLs = 30/Nbins_DLS;
...
cout<<" lfl sum: "<<Get_sumof_hist("h_dl2_lm_ls_MC_lflbg_sum", h_dl2_lm_ls_MC_lflbg_sum, 0)+Get_sumof_hist("h_dl2_lm_us_MC_lflbg_sum", h_dl2_lm_us_MC_lflbg_sum, 0)+Get_sumof_hist("h_dl2_hm_ls_MC_lflbg_sum", h_dl2_hm_ls_MC_lflbg_sum, 0)+Get_sumof_hist("h_dl2_hm_us_MC_lflbg_sum", h_dl2_hm_us_MC_lflbg_sum, 0)<<endl;
cout<<"lfl lm_us: "<<Get_sumof_hist("h_dl2_lm_us_MC_lflbg_sum", h_dl2_lm_us_MC_lflbg_sum, 0)<<endl;
cout<<"lfl lm_ls: "<<Get_sumof_hist("h_dl2_lm_ls_MC_lflbg_sum", h_dl2_lm_ls_MC_lflbg_sum, 0)<<endl;
cout<<"lfl hm_us: "<<Get_sumof_hist("h_dl2_hm_us_MC_lflbg_sum", h_dl2_hm_us_MC_lflbg_sum, 0)<<endl;
...
cout<<endl<<" MC_SUM ="<<Get_sumof_hist("h_dl2_lm_us_allMC_sum", h_dl2_lm_us_allMC_sum, 0)+Get_sumof_hist("h_dl2_lm_ls_allMC_sum", h_dl2_lm_ls_allMC_sum, 0)+Get_sumof_hist("h_dl2_hm_us_allMC_sum", h_dl2_hm_us_allMC_sum, 0)+Get_sumof_hist("h_dl2_hm_ls_allMC_sum", h_dl2_hm_ls_allMC_sum, 0)+(cc_us - cc_ls)+(jpsi_us - jpsi_ls)+Get_sumof_hist("h_dl2_lm_ls_MC_lflbg_sum", h_dl2_lm_ls_MC_lflbg_sum, 0)+Get_sumof_hist("h_dl2_lm_us_MC_lflbg_sum", h_dl2_lm_us_MC_lflbg_sum, 0)+Get_sumof_hist("h_dl2_hm_ls_MC_lflbg_sum", h_dl2_hm_ls_MC_lflbg_sum, 0)+Get_sumof_hist("h_dl2_hm_us_MC_lflbg_sum", h_dl2_hm_us_MC_lflbg_sum, 0)<<endl<<endl;
...
// DL
  ...
  h_dl2_lm_us_data->Add(h_dl2_hm_ls_data,1.);
  h_dl2_lm_us_data->SetMarkerStyle(8);

// format X axis

  h_dl2_lm_us_data->GetXaxis()->SetRangeUser(-100.,100.);
  h_dl2_lm_us_data->GetXaxis()->SetTitle("L_{XY} [cm]");
  h_dl2_lm_us_data->GetXaxis()->SetTitleSize(0.06);
  h_dl2_lm_us_data->GetXaxis()->SetTitleOffset(1.0);
  h_dl2_lm_us_data->GetXaxis()->SetLabelSize(0.04);
  h_dl2_lm_us_data->GetXaxis()->SetLabelOffset(0.005);

// format Y axis

//   h_dl2_lm_us_data->GetYaxis()->SetRangeUser(1.,3300.);
  h_dl2_lm_us_data->GetYaxis()->SetTitle("Events");
  h_dl2_lm_us_data->GetYaxis()->SetTitleSize(0.07);
  h_dl2_lm_us_data->GetYaxis()->SetTitleOffset(1.4);
  h_dl2_lm_us_data->GetYaxis()->SetLabelSize(0.06);
  h_dl2_lm_us_data->GetYaxis()->SetLabelOffset(0.005);

  if(bigmarker)   h_dl2_lm_us_data->SetMarkerSize(0.8);
  else            h_dl2_lm_us_data->SetMarkerSize(.6);

  h_dl2_lm_us_data->Rebin(rebin_value);
  h_dl2_lm_us_data->Draw("P");



/// lfl 
  h_dl2_lm_us_MC_lflbg_sum->Add(h_dl2_hm_us_MC_lflbg_sum,1.);
  h_dl2_lm_us_MC_lflbg_sum->Add(h_dl2_lm_ls_MC_lflbg_sum,1.);
  h_dl2_lm_us_MC_lflbg_sum->Add(h_dl2_hm_ls_MC_lflbg_sum,1.);
  if(bg_black)    h_dl2_lm_us_MC_lflbg_sum->SetFillColor(19); 
  else            h_dl2_lm_us_MC_lflbg_sum->SetFillColor(444); 
  h_dl2_lm_us_MC_lflbg_sum->SetFillStyle(1001);
...
/// c cbar
  ...
  h_dl2_lm_us_MC_c_p_lflbg_sum->Add(h_dl2_lm_us_MC_lflbg_sum,1.);
...
/// Jpsi ...
  ...
  h_dl2_lm_us_allMC_m_charm_sum->Add(h_dl2_lm_us_MC_c_p_lflbg_sum,1.);
...
/// b bbar
  ...
  h_dl2_lm_us_allMC_sum->Add(h_dl2_hm_ls_allMC_sum,1.);

  h_dl2_lm_us_allMC_sum->Add(h_dl2_lm_us_allMC_m_charm_sum,1.);

  if(bg_black)    h_dl2_lm_us_allMC_sum->SetFillColor(111); 
  else            h_dl2_lm_us_allMC_sum->SetFillColor(22222); 
  h_dl2_lm_us_allMC_sum->SetFillStyle(1001);

  h_dl2_lm_us_allMC_sum->Rebin(rebin_value);
  h_dl2_lm_us_allMC_m_charm_sum->Rebin(rebin_value);
  h_dl2_lm_us_MC_c_p_lflbg_sum->Rebin(rebin_value);
  h_dl2_lm_us_MC_lflbg_sum->Rebin(rebin_value);


  h_dl2_lm_us_allMC_sum->Draw("hist same");
  h_dl2_lm_us_allMC_m_charm_sum->Draw("hist same");
  h_dl2_lm_us_MC_c_p_lflbg_sum->Draw("hist same");
  h_dl2_lm_us_MC_lflbg_sum->Draw("hist same");

//Draw data again as top layer

  h_dl2_lm_us_data->Draw("P same");
  ...
  h_dl2_sign_lm_us_data->Add(h_dl2_sign_hm_ls_data,1.);
  h_dl2_sign_lm_us_data->SetMarkerStyle(8);

// format X axis

  h_dl2_sign_lm_us_data->GetXaxis()->SetRangeUser(-15.,15.);
  h_dl2_sign_lm_us_data->GetXaxis()->SetTitle("S = L_{XY}/#sigma_{L_{XY}}");
  h_dl2_sign_lm_us_data->GetXaxis()->SetTitleSize(0.06);
  h_dl2_sign_lm_us_data->GetXaxis()->SetTitleOffset(0.9);
  h_dl2_sign_lm_us_data->GetXaxis()->SetLabelSize(0.04);
  h_dl2_sign_lm_us_data->GetXaxis()->SetLabelOffset(0.005);

// format Y axis

//   h_dl2_sign_lm_us_data->GetYaxis()->SetRangeUser(1.,3300.);
  h_dl2_sign_lm_us_data->SetMinimum(8.);
  h_dl2_sign_lm_us_data->GetYaxis()->SetTitle("Events");
  h_dl2_sign_lm_us_data->GetYaxis()->SetTitleSize(0.07);
  h_dl2_sign_lm_us_data->GetYaxis()->SetTitleOffset(1.4);
  h_dl2_sign_lm_us_data->GetYaxis()->SetLabelSize(0.06);
  h_dl2_sign_lm_us_data->GetYaxis()->SetLabelOffset(0.005);

  if(bigmarker)   h_dl2_sign_lm_us_data->SetMarkerSize(0.8);
  else            h_dl2_sign_lm_us_data->SetMarkerSize(.6);

//   int binmaxd = h_dl2_sign_lm_us_data->GetMaximumBin();
//   double dbinmaxV = h_dl2_sign_lm_us_data->GetBinContent(binmaxd);

// 	  TAxis *axis1 = h_dl2_sign_lm_us_data->GetYaxis();
// 	  axis1->SetLimits(4,dbinmaxV*1.3);

  h_dl2_sign_lm_us_data->Rebin(rebin_value_DLs);
  h_dl2_sign_lm_us_data->Draw("P");


/// lfl 
  h_dl2_sign_lm_us_MC_lflbg_sum->Add(h_dl2_sign_lm_ls_MC_lflbg_sum,1.);
  h_dl2_sign_lm_us_MC_lflbg_sum->Add(h_dl2_sign_hm_us_MC_lflbg_sum,1.);
  h_dl2_sign_lm_us_MC_lflbg_sum->Add(h_dl2_sign_hm_ls_MC_lflbg_sum,1.);
  if(bg_black)    h_dl2_sign_lm_us_MC_lflbg_sum->SetFillColor(19); 
  else            h_dl2_sign_lm_us_MC_lflbg_sum->SetFillColor(444); 
  h_dl2_sign_lm_us_MC_lflbg_sum->SetFillStyle(1001);
...
/// c cbar
  ...
  h_dl2_sign_lm_us_MC_c_p_lflbg_sum->Add(h_dl2_sign_lm_us_MC_lflbg_sum,1.);
...
/// b bbar
  ...
  h_dl2_sign_lm_us_allMC_sum->Add(h_dl2_sign_hm_ls_allMC_sum,1.);

  h_dl2_sign_lm_us_allMC_sum->Add(h_dl2_sign_lm_us_allMC_m_charm_sum,1.);
  if(bg_black)    h_dl2_sign_lm_us_allMC_sum->SetFillColor(111); 
  else            h_dl2_sign_lm_us_allMC_sum->SetFillColor(22222); 
  h_dl2_sign_lm_us_allMC_sum->SetFillStyle(1001);
...
//   h_dl2_sign_hm_ls_MC_lflbg_sum->Scale(0.5);
  ...
  h_dl2_sign_lm_us_allMC_sum->Rebin(rebin_value_DLs);
  h_dl2_sign_lm_us_allMC_m_charm_sum->Rebin(rebin_value_DLs);
  h_dl2_sign_lm_us_MC_c_p_lflbg_sum->Rebin(rebin_value_DLs);
  h_dl2_sign_lm_us_MC_lflbg_sum->Rebin(rebin_value_DLs);


  h_dl2_sign_lm_us_allMC_sum->Draw("hist same");
  h_dl2_sign_lm_us_allMC_m_charm_sum->Draw("hist same");
  h_dl2_sign_lm_us_MC_c_p_lflbg_sum->Draw("hist same");
  h_dl2_sign_lm_us_MC_lflbg_sum->Draw("hist same");

//Draw data again as top layer

  h_dl2_sign_lm_us_data->Draw("P same");
  ...
  h_dl2_lm_us_allMC_sum->Sumw2();
  h_dl2_lm_us_data->Sumw2();
  TH1D* h_dl2_data_copy = (TH1D*) h_dl2_lm_us_data->Clone("h_dl2_data_copy");
  h_dl2_data_copy->Sumw2();

  h_dl2_data_copy->GetYaxis()->SetRangeUser(0.,3.);

  h_dl2_data_copy->Divide(h_dl2_lm_us_allMC_sum);
  h_dl2_data_copy->Draw("E1");


  line1 = new TLine(-1.,1.,1.,1.);
  ...
  h_dl2_sign_lm_us_data->Sumw2();
  h_dl2_sign_lm_us_allMC_sum->Sumw2();
  TH1D* h_dl2_sign_data_copy = (TH1D*) h_dl2_sign_lm_us_data->Clone("h_dl2_sign_data_copy");
  h_dl2_sign_data_copy->Sumw2();

  h_dl2_sign_data_copy->GetYaxis()->SetRangeUser(0.,3.);
  h_dl2_sign_data_copy->Divide(h_dl2_sign_lm_us_allMC_sum);
  h_dl2_sign_data_copy->Draw("E1");

  line2 = new TLine(-15.,1.,15.,1.);
...
/// saving Plot 2: 
string namecanv = "/data/zenith234d/stefan/PhD_work/plots/" + data +"/" + string(name_histo) + "_plot_DL.gif";
const char * c = namecanv.c_str();
canv->SaveAs(c);
cout<<"Plot DL saved : "<<c<<endl;

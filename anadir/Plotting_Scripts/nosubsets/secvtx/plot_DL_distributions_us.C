plot_DL_distributions_us(char *name_histo, Int_t Nbins_DL, Int_t Nbins_DLS)
{
...
// format Y axis
  h_dl2_lm_us_data->GetYaxis()->SetRangeUser(4,4000);
...
// format Y axis
  ...
  h_dl2_sign_lm_us_data->GetYaxis()->SetRangeUser(4.,4000.);
...
/// saving Plot 2: 
string namecanv = "/data/zenith234d/stefan/PhD_work/plots/" + data +"/" + string(name_histo) + "_plot_DL_us.gif";

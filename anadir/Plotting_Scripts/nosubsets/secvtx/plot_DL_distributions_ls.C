plot_DL_distributions_ls(char *name_histo, Int_t Nbins_DL, Int_t Nbins_DLS)
{
...
// format Y axis
  ...
  h_dl2_lm_ls_data->GetYaxis()->SetRangeUser(4.,4000.);
  ...
  h_dl2_lm_ls_data->Rebin(rebin_value);
...
// /// c cbar
//   h_dl2_lm_ls_MC_c_p_lflbg_sum->Add(h_dl2_hm_ls_MC_c_p_lflbg_sum,1.);
//   h_dl2_lm_ls_MC_c_p_lflbg_sum->Add(h_dl2_lm_ls_MC_lflbg_sum,1.);
// 
//   if(bg_black)    h_dl2_lm_ls_MC_c_p_lflbg_sum->SetFillColor(12);
//   else            h_dl2_lm_ls_MC_c_p_lflbg_sum->SetFillColor(333);
//   h_dl2_lm_ls_MC_c_p_lflbg_sum->SetFillStyle(1001);
// 
// /// Jpsi ...
//   h_dl2_lm_ls_allMC_m_charm_sum->Add(h_dl2_hm_ls_allMC_m_charm_sum,1.);
//   h_dl2_lm_ls_allMC_m_charm_sum->Add(h_dl2_lm_ls_MC_c_p_lflbg_sum,1.);
// 
//   if(bg_black)    h_dl2_lm_ls_allMC_m_charm_sum->SetFillColor(16);
//   else            h_dl2_lm_ls_allMC_m_charm_sum->SetFillColor(555);
//   h_dl2_lm_ls_allMC_m_charm_sum->SetFillStyle(1001);


/// b bbar
  h_dl2_lm_ls_allMC_sum->Add(h_dl2_hm_ls_allMC_sum,1.);
  h_dl2_lm_ls_allMC_sum->Add(h_dl2_lm_ls_MC_lflbg_sum,1.);
  ...
  h_dl2_lm_ls_allMC_sum->Rebin(rebin_value);
  h_dl2_lm_ls_allMC_m_charm_sum->Rebin(rebin_value);
  h_dl2_lm_ls_MC_c_p_lflbg_sum->Rebin(rebin_value);
  h_dl2_lm_ls_MC_lflbg_sum->Rebin(rebin_value);


  h_dl2_lm_ls_allMC_sum->Draw("hist same");
//   h_dl2_lm_ls_allMC_m_charm_sum->Draw("hist same");
//   h_dl2_lm_ls_MC_c_p_lflbg_sum->Draw("hist same");
...
// format Y axis
  ...
  h_dl2_sign_lm_ls_data->GetYaxis()->SetRangeUser(4.,4000.);
  h_dl2_sign_lm_ls_data->SetMinimum(8.);
...
//   int binmaxd = h_dl2_sign_lm_ls_data->GetMaximumBin();
//   double dbinmaxV = h_dl2_sign_lm_ls_data->GetBinContent(binmaxd);

// 	  TAxis *axis1 = h_dl2_sign_lm_ls_data->GetYaxis();
// 	  axis1->SetLimits(4,dbinmaxV*1.3);

  h_dl2_sign_lm_ls_data->Rebin(rebin_value_DLs);
...
// /// c cbar
//   h_dl2_sign_lm_ls_MC_c_p_lflbg_sum->Add(h_dl2_sign_hm_ls_MC_c_p_lflbg_sum,1.);
//   h_dl2_sign_lm_ls_MC_c_p_lflbg_sum->Add(h_dl2_sign_lm_ls_MC_lflbg_sum,1.);
//   if(bg_black)    h_dl2_sign_lm_ls_MC_c_p_lflbg_sum->SetFillColor(12);
//   else            h_dl2_sign_lm_ls_MC_c_p_lflbg_sum->SetFillColor(333);
//   h_dl2_sign_lm_ls_MC_c_p_lflbg_sum->SetFillStyle(1001);
// 
// /// J/Psi ...
//   h_dl2_sign_lm_ls_allMC_m_charm_sum->Add(h_dl2_sign_hm_ls_allMC_m_charm_sum,1.);
//   h_dl2_sign_lm_ls_allMC_m_charm_sum->Add(h_dl2_sign_lm_ls_MC_c_p_lflbg_sum,1.);
//   if(bg_black)    h_dl2_sign_lm_ls_allMC_m_charm_sum->SetFillColor(16);
//   else            h_dl2_sign_lm_ls_allMC_m_charm_sum->SetFillColor(555);
//   h_dl2_sign_lm_ls_allMC_m_charm_sum->SetFillStyle(1001);

/// b bbar

  h_dl2_sign_lm_ls_allMC_sum->Add(h_dl2_sign_hm_ls_allMC_sum,1.);
  h_dl2_sign_lm_ls_allMC_sum->Add(h_dl2_sign_lm_ls_MC_lflbg_sum,1.);
...
//   h_dl2_sign_lm_ls_allMC_sum->Scale(0.5);
//   h_dl2_sign_lm_ls_allMC_m_charm_sum->Scale(0.5);
//   h_dl2_sign_lm_ls_MC_c_p_lflbg_sum->Scale(0.5);
//   h_dl2_sign_hm_ls_MC_lflbg_sum->Scale(0.5);

  h_dl2_sign_lm_ls_allMC_sum->Rebin(rebin_value_DLs);
//   h_dl2_sign_lm_ls_allMC_m_charm_sum->Rebin(rebin_value_DLs);
//   h_dl2_sign_lm_ls_MC_c_p_lflbg_sum->Rebin(rebin_value_DLs);
  h_dl2_sign_lm_ls_MC_lflbg_sum->Rebin(rebin_value_DLs);


  h_dl2_sign_lm_ls_allMC_sum->Draw("hist same");
//   h_dl2_sign_lm_ls_allMC_m_charm_sum->Draw("hist same");
//   h_dl2_sign_lm_ls_MC_c_p_lflbg_sum->Draw("hist same");
...
/// saving Plot 2: 
string namecanv = "/data/zenith234d/stefan/PhD_work/plots/" + data +"/" + string(name_histo) + "_plot_DL_ls.gif";

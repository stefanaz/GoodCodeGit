...
GAnalysisHeader::GAnalysisHeader() : TObject() {
  ...
  fPassedAllCutsOnly_mod11 = 0;
  fPassedAllCutsOnly_mod12 = 0;
  fPassedAllCutsOnly_mod13 = 0;
  fPassedAllCutsOnly_mod21 = 0;
  fPassedAllCutsOnly_mod22 = 0;
  fPassedAllCutsOnly_mod23 = 0;
  fPassedAllCutsOnly_mod24 = 0;
  fPassedAllCutsOnly_mod25 = 0;
  fPassedAllCutsOnly_mod26 = 0;
  fPassedAllCutsOnly_mod27 = 0;
  fPassedAllCutsOnly_mod31 = 0;
  fPassedAllCutsOnly_mod32 = 0;
  fPassedAllCutsOnly_mod33 = 0;
  fPassedAllCutsOnly_mod34 = 0;
  fPassedAllCutsOnly_mod35 = 0;
  fPassedAllCutsOnly_mod36 = 0;
  fPassedAllCutsOnly_mod37 = 0;
  fPassedAllCutsOnly_mod41 = 0;
  fPassedAllCutsOnly_mod42 = 0;
  fPassedAllCutsOnly_mod43 = 0;
  fPassedAllCutsOnly_mod44 = 0;
  fPassedAllCutsOnly_mod45 = 0;
  fPassedAllCutsOnly_mod46 = 0;
  fPassedAllCutsOnly_mod47 = 0;
...
///
  if ( gDIMuons->GetAllCuts_mod11() && this->GetAllCuts()  )
    fPassedAllCutsOnly_mod11+=1;

///
  if ( gDIMuons->GetAllCuts_mod12() && this->GetAllCuts()  )
    fPassedAllCutsOnly_mod12+=1;

///

  if (gDIMuons->GetAllCuts_mod13()  && this->GetAllCuts()  ) /* gRuns->GetAllCuts() && gTrigger->GetAllCuts() && gVertex->GetAllCuts() && gSinistra->GetAllCuts() && gCal->GetAllCuts() && gBac->GetAllCuts() && gZufo->GetAllCuts() && gJets->GetAllCuts() && gTracks->GetAllCuts() && gMuons->GetAllCuts() && gMJMatchs->GetAllCuts() && gTJMatchs->GetAllCuts() && gMVD->GetAllCuts() && gDIMuons->GetAllCuts()) */
    fPassedAllCutsOnly_mod13+=1;

///
  if ( gDIMuons->GetAllCuts_mod21()  && this->GetAllCuts() )
    fPassedAllCutsOnly_mod21+=1;

///
  if ( gDIMuons->GetAllCuts_mod22()  && this->GetAllCuts() )
    fPassedAllCutsOnly_mod22+=1;

///
  if ( gDIMuons->GetAllCuts_mod23() && this->GetAllCuts() )
    fPassedAllCutsOnly_mod23+=1;

///
  if ( gDIMuons->GetAllCuts_mod24() && this->GetAllCuts())
    fPassedAllCutsOnly_mod24+=1;

///
  if ( gDIMuons->GetAllCuts_mod25() && this->GetAllCuts())
    fPassedAllCutsOnly_mod25+=1;

///
  if ( gDIMuons->GetAllCuts_mod26() && this->GetAllCuts())
    fPassedAllCutsOnly_mod26+=1;

///
  if ( gDIMuons->GetAllCuts_mod27() && this->GetAllCuts())
    fPassedAllCutsOnly_mod27+=1;

/// ///
  if ( gDIMuons->GetAllCuts_mod31() && this->GetAllCuts())
    fPassedAllCutsOnly_mod31+=1;

///
  if ( gDIMuons->GetAllCuts_mod32() && this->GetAllCuts())
    fPassedAllCutsOnly_mod32+=1;

///
  if ( gDIMuons->GetAllCuts_mod33() && this->GetAllCuts())
    fPassedAllCutsOnly_mod33+=1;

///
  if ( gDIMuons->GetAllCuts_mod34() && this->GetAllCuts())
    fPassedAllCutsOnly_mod34+=1;

///
  if ( gDIMuons->GetAllCuts_mod35() && this->GetAllCuts())
    fPassedAllCutsOnly_mod35+=1;

///
  if ( gDIMuons->GetAllCuts_mod36() && this->GetAllCuts())
    fPassedAllCutsOnly_mod36+=1;

///
  if ( gDIMuons->GetAllCuts_mod37() && this->GetAllCuts())
    fPassedAllCutsOnly_mod37+=1;

/// /// /// 
/// ///
  if ( gDIMuons->GetAllCuts_mod41() && this->GetAllCuts())
    fPassedAllCutsOnly_mod41+=1;

///
  if ( gDIMuons->GetAllCuts_mod42() && this->GetAllCuts())
    fPassedAllCutsOnly_mod42+=1;

///
  if ( gDIMuons->GetAllCuts_mod43() && this->GetAllCuts())
    fPassedAllCutsOnly_mod43+=1;

///
  if ( gDIMuons->GetAllCuts_mod44() && this->GetAllCuts())
    fPassedAllCutsOnly_mod44+=1;

///
  if ( gDIMuons->GetAllCuts_mod45() && this->GetAllCuts())
    fPassedAllCutsOnly_mod45+=1;

///
  if ( gDIMuons->GetAllCuts_mod46() && this->GetAllCuts())
    fPassedAllCutsOnly_mod46+=1;

///
  if ( gDIMuons->GetAllCuts_mod47() && this->GetAllCuts())
    fPassedAllCutsOnly_mod47+=1;
...
TString GAnalysisHeader::ReturnFooter(TString title) {
  ...
  dummy.Append(this->ReturnLine("events passed all cuts + 0 jets   2 muons > 4 GeV			 ",this->GetPassedAllCutsOnly_mod11(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 0 jets   2 muons <= 4GeV			 ",this->GetPassedAllCutsOnly_mod12(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 0 jets , >2 muons				 ",this->GetPassedAllCutsOnly_mod13(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");

  dummy.Append(this->ReturnLine("events passed all cuts + 1 jets , 2 muons > 4GeV, both  related to jets ",this->GetPassedAllCutsOnly_mod21(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 1 jets , 2 muons > 4GeV, one   related to jets ",this->GetPassedAllCutsOnly_mod22(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 1 jets , 2 muons > 4GeV, noone related to jets ",this->GetPassedAllCutsOnly_mod23(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 1 jets , 2 muons <= 4GeV, both related to jets ",this->GetPassedAllCutsOnly_mod24(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 1 jets , 2 muons <= 4GeV, one  related to jets ",this->GetPassedAllCutsOnly_mod25(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 1 jets , 2 muons <= 4GeV, noone related to jets",this->GetPassedAllCutsOnly_mod26(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 1 jets , >2 muons 				 ",this->GetPassedAllCutsOnly_mod27(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");

  dummy.Append(this->ReturnLine("events passed all cuts + 2 jets , 2 muons > 4GeV, both  related to jets ",this->GetPassedAllCutsOnly_mod31(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 2 jets , 2 muons > 4GeV, one   related to jets ",this->GetPassedAllCutsOnly_mod32(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 2 jets , 2 muons > 4GeV, noone related to jets ",this->GetPassedAllCutsOnly_mod33(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 2 jets , 2 muons <= 4GeV, both related to jets ",this->GetPassedAllCutsOnly_mod34(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 2 jets , 2 muons <= 4GeV, one  related to jets ",this->GetPassedAllCutsOnly_mod35(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 2 jets , 2 muons <= 4GeV, noone related to jets",this->GetPassedAllCutsOnly_mod36(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + 2 jets , >2 muons				 ",this->GetPassedAllCutsOnly_mod37(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + >2 jets , 2 muons > 4GeV, both  related to jets ",this->GetPassedAllCutsOnly_mod41(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + >2 jets , 2 muons > 4GeV, one   related to jets ",this->GetPassedAllCutsOnly_mod42(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + >2 jets , 2 muons > 4GeV, noone related to jets ",this->GetPassedAllCutsOnly_mod43(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + >2 jets , 2 muons <= 4GeV, both related to jets ",this->GetPassedAllCutsOnly_mod44(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + >2 jets , 2 muons <= 4GeV, one  related to jets ",this->GetPassedAllCutsOnly_mod45(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + >2 jets , 2 muons <= 4GeV, noone related to jets",this->GetPassedAllCutsOnly_mod46(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine("events passed all cuts + >2 jets , >2 muons				  ",this->GetPassedAllCutsOnly_mod47(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append("\n");
  dummy.Append("\n");

  dummy.Append(this->ReturnLine("Check SUM =								  ",this->GetPassedAllCutsOnly_mod11()+this->GetPassedAllCutsOnly_mod12()+this->GetPassedAllCutsOnly_mod13()+this->GetPassedAllCutsOnly_mod21()+this->GetPassedAllCutsOnly_mod22()+this->GetPassedAllCutsOnly_mod23()+this->GetPassedAllCutsOnly_mod24()+this->GetPassedAllCutsOnly_mod25()+this->GetPassedAllCutsOnly_mod26()+this->GetPassedAllCutsOnly_mod27()+this->GetPassedAllCutsOnly_mod31()+this->GetPassedAllCutsOnly_mod32()+this->GetPassedAllCutsOnly_mod33()+this->GetPassedAllCutsOnly_mod34()+this->GetPassedAllCutsOnly_mod35()+this->GetPassedAllCutsOnly_mod36()+this->GetPassedAllCutsOnly_mod37()+this->GetPassedAllCutsOnly_mod41()+this->GetPassedAllCutsOnly_mod42()+this->GetPassedAllCutsOnly_mod43()+this->GetPassedAllCutsOnly_mod44()+this->GetPassedAllCutsOnly_mod45()+this->GetPassedAllCutsOnly_mod46()+this->GetPassedAllCutsOnly_mod47(),this->GetPassedAllCutsCons(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");

  dummy.Append("\n==========================================================================\n");

  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod11(),this->GetPassedAllCutsOnly_mod11(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod12(),this->GetPassedAllCutsOnly_mod12(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod13(),this->GetPassedAllCutsOnly_mod13(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");

  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod21(),this->GetPassedAllCutsOnly_mod21(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod22(),this->GetPassedAllCutsOnly_mod22(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod23(),this->GetPassedAllCutsOnly_mod23(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod24(),this->GetPassedAllCutsOnly_mod24(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod25(),this->GetPassedAllCutsOnly_mod25(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod26(),this->GetPassedAllCutsOnly_mod26(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod27(),this->GetPassedAllCutsOnly_mod27(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");

  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod31(),this->GetPassedAllCutsOnly_mod31(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod32(),this->GetPassedAllCutsOnly_mod32(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod33(),this->GetPassedAllCutsOnly_mod33(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod34(),this->GetPassedAllCutsOnly_mod34(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod35(),this->GetPassedAllCutsOnly_mod35(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod36(),this->GetPassedAllCutsOnly_mod36(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod37(),this->GetPassedAllCutsOnly_mod37(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");

  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod41(),this->GetPassedAllCutsOnly_mod41(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod42(),this->GetPassedAllCutsOnly_mod42(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod43(),this->GetPassedAllCutsOnly_mod43(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod44(),this->GetPassedAllCutsOnly_mod44(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod45(),this->GetPassedAllCutsOnly_mod45(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod46(),this->GetPassedAllCutsOnly_mod46(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");
  dummy.Append(this->ReturnLine(" ",this->GetPassedAllCutsOnly_mod47(),this->GetPassedAllCutsOnly_mod47(),this->GetPassedAllCutsExcl()));
  dummy.Append("\n");

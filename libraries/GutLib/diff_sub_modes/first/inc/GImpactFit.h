...
class GImpactFit : public TObject {
...
public:
  GImpactFit();
  GImpactFit(TString name, Double_t bscale, Double_t bscaleerr, Double_t clfscale, Double_t clfscaleerr, Double_t bfraction, Double_t bfractionerr, Double_t chi2, Int_t bins, Int_t parameter);
  virtual ~GImpactFit();
  ...
  ClassDef(GImpactFit,1) // Impact Parameter Fit parameter
};

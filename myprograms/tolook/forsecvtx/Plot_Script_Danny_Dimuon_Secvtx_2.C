...
/// lfl 
  h_dl2_hm_ls_MC_lflbg_sum->Add(h_dl2_hm_us_MC_lflbg_sum,1.);
  h_dl2_hm_ls_MC_lflbg_sum->Add(h_dl2_lm_ls_MC_lflbg_sum,1.);
  h_dl2_hm_ls_MC_lflbg_sum->Add(h_dl2_lm_us_MC_lflbg_sum,1.);
...
/// lfl 
  h_dl2_sign_hm_ls_MC_lflbg_sum->Add(h_dl2_sign_hm_us_MC_lflbg_sum,1.);
  h_dl2_sign_hm_ls_MC_lflbg_sum->Add(h_dl2_sign_lm_ls_MC_lflbg_sum,1.);
  h_dl2_sign_hm_ls_MC_lflbg_sum->Add(h_dl2_sign_lm_us_MC_lflbg_sum,1.);

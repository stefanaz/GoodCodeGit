...
TH1D* h_dl2_sign_mirr_hm_ls_allMC_m_charm_sum     = (TH1D*) h_dl2_sign_mirrp_hm_ls_allMC_m_charm_sum->Clone("h_dl2_sign_mirr_hm_ls_allMC_m_charm_sum");
      h_dl2_sign_mirr_hm_ls_allMC_m_charm_sum     -> Add(h_dl2_sign_mirrm_hm_ls_allMC_m_charm_sum,-1.);

TH1D* h_dl2_sign_mirr_hm_ls_MC_c_p_lflbg_sum      = (TH1D*) h_dl2_sign_mirrp_hm_ls_MC_c_p_lflbg_sum->Clone("h_dl2_sign_mirr_hm_ls_MC_c_p_lflbg_sum");
      h_dl2_sign_mirr_hm_ls_MC_c_p_lflbg_sum       -> Add(h_dl2_sign_mirrm_hm_ls_MC_c_p_lflbg_sum,-1.);
...
TH1D* h_dl2_sign_mirr_lm_ls_allMC_m_charm_sum     = (TH1D*) h_dl2_sign_mirrp_lm_ls_allMC_m_charm_sum->Clone("h_dl2_sign_mirr_lm_ls_allMC_m_charm_sum");
      h_dl2_sign_mirr_lm_ls_allMC_m_charm_sum     -> Add(h_dl2_sign_mirrm_lm_ls_allMC_m_charm_sum,-1.);

TH1D* h_dl2_sign_mirr_lm_ls_MC_c_p_lflbg_sum      = (TH1D*) h_dl2_sign_mirrp_lm_ls_MC_c_p_lflbg_sum->Clone("h_dl2_sign_mirr_lm_ls_MC_c_p_lflbg_sum");
      h_dl2_sign_mirr_lm_ls_MC_c_p_lflbg_sum       -> Add(h_dl2_sign_mirrm_lm_ls_MC_c_p_lflbg_sum,-1.);
...
/// lfl
  h_dl2_lm_ls_MC_lflbg_sum->Add(h_dl2_lm_ls_MC_lflbg_sum,1.);
  h_dl2_lm_ls_MC_lflbg_sum->Add(h_dl2_hm_ls_MC_lflbg_sum,1.);
  h_dl2_lm_ls_MC_lflbg_sum->Add(h_dl2_hm_ls_MC_lflbg_sum,1.);
  if(bg_black)    h_dl2_lm_ls_MC_lflbg_sum->SetFillColor(19); 
  else            h_dl2_lm_ls_MC_lflbg_sum->SetFillColor(444); 
  h_dl2_lm_ls_MC_lflbg_sum->SetFillStyle(1001);
...
/// c ccbar
  ...
  h_dl2_lm_us_MC_c_p_lflbg_sum->Add(h_dl2_lm_ls_MC_lflbg_sum,1.);
...
//Draw data again as top layer
  ...
  h_dl2_lm_ls_MC_lflbg_sum->Draw("hist same");
...
/// lfl
  h_dl2_sign_lm_ls_MC_lflbg_sum->Add(h_dl2_sign_lm_ls_MC_lflbg_sum,1.);
  h_dl2_sign_lm_ls_MC_lflbg_sum->Add(h_dl2_sign_hm_ls_MC_lflbg_sum,1.);
  h_dl2_sign_lm_ls_MC_lflbg_sum->Add(h_dl2_sign_hm_ls_MC_lflbg_sum,1.);
  if(bg_black)    h_dl2_sign_lm_ls_MC_lflbg_sum->SetFillColor(19); 
  else            h_dl2_sign_lm_ls_MC_lflbg_sum->SetFillColor(444); 
  h_dl2_sign_lm_ls_MC_lflbg_sum->SetFillStyle(1001);
...
/// c ccbar
  ...
  h_dl2_sign_lm_us_MC_c_p_lflbg_sum->Add(h_dl2_sign_lm_ls_MC_lflbg_sum,1.);
...
//Draw data again as top layer
  ...
  h_dl2_sign_lm_ls_MC_lflbg_sum->Draw("hist same");
...
/// lfl
  h_dl2_err_lm_ls_MC_lflbg_sum->Add(h_dl2_err_lm_ls_MC_lflbg_sum,1.);
  h_dl2_err_lm_ls_MC_lflbg_sum->Add(h_dl2_err_hm_ls_MC_lflbg_sum,1.);
  h_dl2_err_lm_ls_MC_lflbg_sum->Add(h_dl2_err_hm_ls_MC_lflbg_sum,1.);

  h_dl2_err_lm_ls_MC_lflbg_sum->Add(h_dl2_err_hm_ls_MC_lflbg_sum,1.);

  if(bg_black)    h_dl2_err_lm_ls_MC_lflbg_sum->SetFillColor(19); 
  else            h_dl2_err_lm_ls_MC_lflbg_sum->SetFillColor(444); 
  h_dl2_err_lm_ls_MC_lflbg_sum->SetFillStyle(1001);
...
/// c ccbar
  ...
  h_dl2_err_lm_us_MC_c_p_lflbg_sum->Add(h_dl2_err_lm_ls_MC_lflbg_sum,1.);
...
//Draw data again as top layer
  ...
  h_dl2_err_lm_ls_MC_lflbg_sum->Draw("hist same");
  ...
  leg6->AddEntry(h_dl2_err_lm_ls_MC_lflbg_sum,"lfl bg","f");
  leg6->Draw();
...
/// lfl
  h_dl2_sign_mirr_lm_ls_MC_lflbg_sum->Add(h_dl2_sign_mirr_lm_ls_MC_lflbg_sum,1.);
  h_dl2_sign_mirr_lm_ls_MC_lflbg_sum->Add(h_dl2_sign_mirr_hm_ls_MC_lflbg_sum,1.);
  h_dl2_sign_mirr_lm_ls_MC_lflbg_sum->Add(h_dl2_sign_mirr_hm_ls_MC_lflbg_sum,1.);
  if(bg_black)    h_dl2_sign_mirr_lm_ls_MC_lflbg_sum->SetFillColor(19); 
  else            h_dl2_sign_mirr_lm_ls_MC_lflbg_sum->SetFillColor(444); 
  h_dl2_sign_mirr_lm_ls_MC_lflbg_sum->SetFillStyle(1001);

/// c cbar
  h_dl2_sign_mirr_lm_us_MC_c_p_lflbg_sum->Add(h_dl2_sign_mirr_hm_us_MC_c_p_lflbg_sum,1.);
  h_dl2_sign_mirr_lm_us_MC_c_p_lflbg_sum->Add(h_dl2_sign_mirr_lm_ls_MC_c_p_lflbg_sum,-1.);
  h_dl2_sign_mirr_lm_us_MC_c_p_lflbg_sum->Add(h_dl2_sign_mirr_hm_ls_MC_c_p_lflbg_sum,-1.);

  h_dl2_sign_mirr_lm_us_MC_c_p_lflbg_sum->Add(h_dl2_sign_mirr_lm_ls_MC_lflbg_sum,1.);
...
/// Jpsi ...
  ...
  h_dl2_sign_mirr_lm_us_allMC_m_charm_sum->Add(h_dl2_sign_mirr_lm_ls_allMC_m_charm_sum,-1.);
  h_dl2_sign_mirr_lm_us_allMC_m_charm_sum->Add(h_dl2_sign_mirr_hm_ls_allMC_m_charm_sum,-1.);

  h_dl2_sign_mirr_lm_us_allMC_m_charm_sum->Add(h_dl2_sign_mirr_lm_us_MC_c_p_lflbg_sum,1.);
...
/// b bbar
  ...
  h_dl2_sign_mirr_lm_us_allMC_sum->Add(h_dl2_sign_mirr_lm_us_allMC_m_charm_sum,1.);
  ...
  h_dl2_sign_mirr_lm_ls_MC_lflbg_sum->Draw("hist same");
...
//Draw data again as top layer
//   h_dl2_sign_mirr_lm_us_data->SetMinimum(0.);
  h_dl2_sign_mirr_lm_us_data->Draw("P");
  h_dl2_sign_mirr_lm_us_allMC_sum->Draw("hist same");
  h_dl2_sign_mirr_lm_us_allMC_m_charm_sum->Draw("hist same");
  h_dl2_sign_mirr_lm_us_MC_c_p_lflbg_sum->Draw("hist same");

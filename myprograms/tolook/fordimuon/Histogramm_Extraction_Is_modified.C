Int_t Histogramm_Extraction_Is(Bool_t highmass=true, Bool_t autoquit=false){
...
// s_MC^b = (d^u-d^l-(c^u+bh^u+jpsi^u+psiprime^u))/(b^u-b^l)
  ...
  Double_t useccbarincl = 1.0/*1.0*/; // 1.8 if like sign charm is subtracted. In the old sample there was
  ...
  TString iso_chooser   = "is"; // possible values: is, nis & nisandis
...
// Set plotting parametes:
  ...
  if(!plot_diffxsec)  Double_t MC_scale_b = 1.85;         // tuning 080116 - for tot. xsec with BHadron ptb PAPERED2
  ...
  if(!plot_diffxsec)  Double_t MC_scale_jpsi2 = 0.036;    // tuning 080116 - for tot. xsec with BHadron ptb PAPERED2, new charm 1.37
...
// do something with obj
	  ...
	  previous_obj = key->GetName(); //if (i==11) {cout<<obj[count1][i]->GetName()<<endl;}
	  count1++;
	}
      file->Close();
    }
...
// cout<<obj[311+i][charmbegin]->GetName()<<endl;
// }

cout<<obj[251][0]->GetName()<<endl;

// reweight MC histos and add the reweighted ones:

cout<<"MC_scale_BH_DIS = "<<MC_scale_BH_DIS*(data_lumi/22379.)<<endl;
cout<<"MC_scale_BH_ela = "<<MC_scale_BH_ela*(data_lumi/1546.21)<<endl;
cout<<"MC_scale_BH_inela = "<<MC_scale_BH_inela*(data_lumi/2747.01)<<endl;
cout<<"MC_scale_jpsi1 = "<<MC_scale_jpsi1*(data_lumi/6986.)<<endl;
cout<<"MC_scale_jpsi2 = "<<MC_scale_jpsi2*(data_lumi/414.07)<<endl;
cout<<"MC_scale_psiprime1 = "<<MC_scale_psiprime1*(data_lumi/6545.)<<endl;
cout<<"MC_scale_psiprime2 = "<<MC_scale_psiprime2*(data_lumi/581.39536)<<endl;
cout<<"MC_scale_ups1 = "<<MC_scale_ups1*(data_lumi/357.608)<<endl;
cout<<"MC_scale_ups2 = "<<MC_scale_ups2*(data_lumi/357.608)<<endl;
cout<<"MC_scale_ups3 = "<<MC_scale_ups3*(data_lumi/357.608)<<endl;

cout<<"MC_scale_BH_DIS = "<<MC_scale_BH_DIS<<endl;
cout<<"MC_scale_BH_ela = "<<MC_scale_BH_ela<<endl;
cout<<"MC_scale_BH_inela = "<<MC_scale_BH_inela<<endl;
cout<<"MC_scale_jpsi1 = "<<MC_scale_jpsi1<<endl;
cout<<"MC_scale_jpsi2 = "<<MC_scale_jpsi2<<endl;
cout<<"MC_scale_psiprime1 = "<<MC_scale_psiprime1<<endl;
cout<<"MC_scale_psiprime2 = "<<MC_scale_psiprime2<<endl;
cout<<"MC_scale_ups1 = "<<MC_scale_ups1<<endl;
cout<<"MC_scale_ups2 = "<<MC_scale_ups2<<endl;
cout<<"MC_scale_ups3 = "<<MC_scale_ups3<<endl;
...
//       if(j==03)  obj[k][j]->Scale( dim_fl_exc*MC_scale_b *(data_lumi_06_07/ 1736.66 ) ); // b_06p-07p_exproton.root  // from webpage 1763.66  ??
// /// ??? can not check : 
...
// 
// 
//       if(j==24)  obj[k][j]->Scale( rapgapscale*MC_scale_c *(data_lumi_03_04/ 124.491  ) ); // c_03p-04p_dirrap.root	// 124.335 (Q2 > 4GeV2) +
//       if(j==25)  obj[k][j]->Scale( rapgapscale*MC_scale_c *(data_lumi_05_06/ 449.839  ) ); // c_05e-06e_dirrap.root	// 447.7 (Q2 > 4GeV2) or 1175.05 (Q2 > 16GeV2)
//       if(j==26)  obj[k][j]->Scale( rapgapscale*MC_scale_c *(data_lumi_06_07/ 498.047  ) ); // c_06p-07p_dirrap.root	// 498.042 (Q2 > 4GeV2)
//       if(j==27)  obj[k][j]->Scale( rapgapscale*MC_scale_c *(data_lumi_03_04/  41.444  ) ); // c_03p-04p_resrap.root	// 41.445 (Q2 > 4GeV2)
...
//     
//       if(j==43)  obj[k][j]->Scale( rapgapscale*MC_scale_b *(data_lumi_03_04/ 1167.787 ) ); // b_03p-04p_dirrap.root  +  // divide on 27 ...
//        if(j==44)  obj[k][j]->Scale( rapgapscale*MC_scale_b *(data_lumi_05_06/ 3040.652 ) ); // b_05e-06e_dirrap.root +	// divide on 16 ...
//       if(j==45)  obj[k][j]->Scale( rapgapscale*MC_scale_b *(data_lumi_06_07/ 2577.944 ) ); // b_06p-07p_dirrap.root  +  // divide on 18 ...
//       if(j==46)  obj[k][j]->Scale( rapgapscale*MC_scale_b *(data_lumi_03_04/ 1167.247 ) ); // b_03p-04p_resrap.root  +	// divide on 27.-32. ...
...
/// N.Stefaniuk , modified charm lumi , due to thesis and lumi web page: 
...
//   cout<<" NHistos = "<<nhistos<<endl;
  ...
  for(Int_t plotss = 11; plotss < 12/*pl_range*/; plotss++)
    { // plotting loop start >>>
...
/// Name Histo checking: 
cout<<"Data LS = "<<obj[histonr+38][dataposition]->GetName()<<endl;
cout<<"Data US = "<<obj[histonr][dataposition]->GetName()<<endl;
...
cout<<" LS ccbar : "<<endl;
cout<<" Nbins1 = "<<obj[histonr+nhistos][charmbegin]->GetNbinsX()<<endl;
cout<<" US ccbar : "<<endl;
cout<<" Nbins2 = "<<obj[histonr][charmbegin]->GetNbinsX()<<endl;

cout<<endl<<" LS bbar : "<<endl;
cout<<" Nbins1 = "<<obj[histonr+nhistos][0]->GetNbinsX()<<endl;
cout<<" US bbar : "<<endl;
cout<<" Nbins2 = "<<obj[histonr][0]->GetNbinsX()<<endl;



cout<<endl<< " LS JPSI :"<<endl;

cout<<" Nbins1 = "<<obj[histonr+nhistos][jpsi_position1]->GetNbinsX()<<endl;
cout<<" Nbins2 = "<<obj[histonr+nhistos][jpsi_position2]->GetNbinsX()<<endl;
cout<<" Nbins3 = "<<obj[histonr+nhistos][psiprime_position1]->GetNbinsX()<<endl;
cout<<" Nbins4 = "<<obj[histonr+nhistos][psiprime_position2]->GetNbinsX()<<endl;
cout<<" Nbins5 = "<<obj[histonr+nhistos][BH_position1]->GetNbinsX()<<endl;
cout<<" Nbins6 = "<<obj[histonr+nhistos][BH_position2]->GetNbinsX()<<endl;
cout<<" Nbins7 = "<<obj[histonr+nhistos][BH_position3]->GetNbinsX()<<endl;
cout<<" Nbins8 = "<<obj[histonr+nhistos][ups1_position]->GetNbinsX()<<endl;
cout<<" Nbins9 = "<<obj[histonr+nhistos][ups2_position]->GetNbinsX()<<endl;
cout<<" Nbins10 = "<<obj[histonr+nhistos][ups3_position]->GetNbinsX()<<endl;

cout<< " US JPSI :"<<endl;
cout<<" Nbins1 = "<<obj[histonr][jpsi_position1]->GetNbinsX()<<endl;
cout<<" Nbins2 = "<<obj[histonr][jpsi_position2]->GetNbinsX()<<endl;
cout<<" Nbins3 = "<<obj[histonr][psiprime_position1]->GetNbinsX()<<endl;
cout<<" Nbins4 = "<<obj[histonr][psiprime_position2]->GetNbinsX()<<endl;
cout<<" Nbins5 = "<<obj[histonr][BH_position1]->GetNbinsX()<<endl;
cout<<" Nbins6 = "<<obj[histonr][BH_position2]->GetNbinsX()<<endl;
cout<<" Nbins7 = "<<obj[histonr][BH_position3]->GetNbinsX()<<endl;
cout<<" Nbins8 = "<<obj[histonr][ups1_position]->GetNbinsX()<<endl;
cout<<" Nbins9 = "<<obj[histonr][ups2_position]->GetNbinsX()<<endl;
cout<<" Nbins10 = "<<obj[histonr][ups3_position]->GetNbinsX()<<endl;
...
cout<<endl<<" LS data : "<<endl;
cout<<" Nbins1 = "<<obj[histonr+nhistos][dataposition]->GetNbinsX()<<endl;
cout<<" US data : "<<endl;
cout<<" Nbins2 = "<<obj[histonr][dataposition]->GetNbinsX()<<endl;



	  lfl_bg_us[plotss] = (TH1D*) obj[histonr][dataposition]->Clone("lfl_bg_us");
	  lfl_bg_ls[plotss] = (TH1D*) obj[histonr+nhistos][dataposition]->Clone("lfl_bg_ls");

	  lfl_bg_us[plotss]->Add(obj[histonr][0],-1);
	  lfl_bg_ls[plotss]->Add(obj[histonr+nhistos][0],-1); 			// subtract b-MC hm_ls
